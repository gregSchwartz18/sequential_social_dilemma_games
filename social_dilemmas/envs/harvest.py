...
class HarvestEnv(MapEnv):
    ...
    def custom_map_update(self):
        ...
        save_path = '/home/gds38/Desktop/storage/'
        completeName = os.path.join(save_path, "stored_info_apple.txt") 
        with open(completeName, "a") as app_out:
            pprint( self.count_apples(self.world_map), app_out )

        save_path = '/home/gds38/Desktop/storage/'
        completeName = os.path.join(save_path, "stored_info_final_apple.txt") 
        with open(completeName, "w") as app_out:
            pprint( self.count_apples(self.world_map), app_out )

        #print(self.count_apples(self.world_map))
